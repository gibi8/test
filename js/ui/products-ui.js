    ...
    <div class="product-info">
        ...
        <div class="product-footer">
            ...
            <div class="product-actions">
                <button class="btn-cart" onclick="event.stopPropagation(); window.addToCart('${product.id}')" data-i18n="product_add">Dodaj</button>
                <button class="btn-buy" onclick="event.stopPropagation(); window.buyNow('${product.id}')" data-i18n="product_buy">Kup</button>
            </div>
        </div>
    </div>
`;;
